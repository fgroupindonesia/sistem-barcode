        ...
        <div class="search-field ml-4 d-none d-md-block">
          <form class="d-flex align-items-stretch h-100" action="#">
            <div class="input-group">
              <input id="search-box" data-management="boxes" type="text" class="form-control bg-transparent border-0" placeholder="Search">
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-7 grid-margin stretch-card">
             <button id="btn-add" data-management="boxes" type="button" class="btn btn-primary">
			 <span class="btn__txt">Add New</span>
			</button>

			<button id="btn-edit" data-management="boxes" type="button" class="btn btn-primary">
				<span class="btn__txt">Edit</span>
			</button>

			<button id="btn-delete" data-management="boxes" type="button" class="btn btn-primary">
                  ...
                  <div class="table-responsive table-hover">
                    <table class="table">
					  ...
					  <?php if (!empty($entries)): ?>
						...
						<?php foreach ($entries as $data_box): ?>
