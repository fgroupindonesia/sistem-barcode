...
<head>
  ...
  <title>Sistem Barcode - Management Box</title>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-12 grid-margin">
             <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Data Box (Editing)</h4>
                      <p class="card-description">
                        Pengisian
                      </p>
                      <form class="forms-sample needs-validation" action="/box/update" method="post" >
					   <input type="hidden" name="id" value="<?= ($entry[0]->id); ?>" />
					  <div class="form-group">
                          <label class="form-label" for="barcode">Barcode</label>
                          <input type="text" class="form-control" id="barcode" name="barcode" value="<?= ($entry[0]->barcode); ?>" placeholder="isi kode barcode" required>
						   <div class="invalid-feedback">
							Tuliskan Barcode Box.
						  </div>
                       </div>
					   
					   <div class="form-group">
                          <label for="quantity_stock">Quantity Stock</label>
                          <input name="quantity_stock" value="<?= ($entry[0]->quantity_stock); ?>" type="text" value="" class="form-control" id="quantity_stock" placeholder="tuliskan quantity">
                       </div>
