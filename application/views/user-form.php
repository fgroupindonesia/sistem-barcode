            ...
            <div class="col-12 grid-margin">
             <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample needs-validation" action="/user/add" method="post" >
					 
					  <div class="form-group">
                          <label class="form-label" for="nama_lengkap">Nama Lengkap</label>
                          <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="isi nama lengkap anda sesuai ktp" required>
					   ...
					   <div class="form-group">
                          ...
                          <input name="no_telepon" type="text" value="" class="form-control" id="no_telepon" placeholder="tuliskan nomor Telepon whatsapp yang aktif">
                       </div>
                        <div class="form-group">
                          <label for="email">Email address</label>
                          <input name="email" type="email" value="" class="form-control" id="email" placeholder="Masukkan email terkini">
                        </div>
						 <div class="form-group">
                          <label for="username">Username</label>
                          <input name="username" type="text" value="" class="form-control" id="username" placeholder="isi username untuk login">
                       </div>
                        <div class="form-group">
                          <label for="pass">Password</label>
                          <input name="pass" type="password" value="" class="form-control" id="pass" placeholder="Password">
                        </div>
						<div class="form-group">
