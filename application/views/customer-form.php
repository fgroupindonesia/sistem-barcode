            ...
            <div class="col-12 grid-margin">
             <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample needs-validation" action="/customer/add" method="post" >
					 
					  <div class="form-group">
                          <label class="form-label" for="nama">Nama</label>
                          <input type="text" class="form-control" id="nama" name="nama" placeholder="isi nama pelanggan" required>
					   ...
					   <div class="form-group">
                          ...
                          <input name="alamat" type="text" value="" class="form-control" id="alamat" placeholder="tuliskan alamatnya">
                       </div>
						
						<div class="form-group">
                          <label for="no_telepon">No Telepon</label>
                          <input name="no_telepon" type="text" value="" class="form-control" id="no_telepon" placeholder="tuliskan no.telepon yang aktif">
                       </div>
