      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <div class="row purchace-popup">
            <div class="col-12">
              <span "marquee-container d-flex alifn-items-center">
            ...
            <div class="col-12 grid-margin">
             <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample needs-validation" action="/box/add" method="post" >
					 
					  <div class="form-group">
                          <label class="form-label" for="barcode">Barcode</label>
                          <input type="text" class="form-control" id="barcode" name="barcode" placeholder="isi kode barcode" required>
					   ...
					   <div class="form-group">
                          ...
                          <input name="quantity_stock" type="text" value="" class="form-control" id="quantity_stock" placeholder="tuliskan quantity">
                       </div>
