        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-12 grid-margin">
             <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Data Info (Editing)</h4>
                      <p class="card-description">
                        Pengisian
                      </p>
                      <form class="forms-sample needs-validation" action="/info/update" method="post" >
					   <input type="hidden" name="id" value="<?= ($entry[0]->id); ?>" />
					 

						<div class="form-group">
                          <label class="form-label" for="berita">Berita</label>
                          <input type="text" class="form-control" value="<?= ($entry[0]->berita); ?>" id="berita" name="berita" placeholder="isi berita anda disini." required>
					   ...
					   <div class="form-group">
                          ...
                          <input name="started_date" type="text" value="<?= ($entry[0]->started_date); ?>" class="form-control" id="started_date" placeholder="pilih tanggal bermula">
                       </div>
 
						<div class="form-group">
                          <label for="ended_date">Ended Date</label>
                          <input name="ended_date"  type="text" value="<?= ($entry[0]->ended_date); ?>" class="form-control" id="ended_date" placeholder="pilih tanggal berakhir">
                       </div>
                       
                        <button type="submit" class="btn btn-success mr-2">Submit</button>
                        <input type="button" data-management="info" id="btn-cancel" class="btn btn-light" value="Cancel">
                      </form>
                    </div>
                  </div>
            </div>
